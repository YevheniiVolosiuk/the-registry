...
## Context
First-time setup of The Registry on a new device. The user either has the template repo cloned directly, or has already forked it to their own private repo.
...
- Update the `## Variables` section:
  - **REGISTRY_REPO_URL**: Set to the user's fork URL
